...
Mobazha Community Edition is maintained by the Mobazha organization with contributions from the community.
...
- Implementing a plugin does not add its capability to the default Community Edition.
