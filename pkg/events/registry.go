...
func init() {
	registry = []EventMeta{
		...
		{Category: "order", Name: "order.rated", Persistent: true, Sample: new(OrderRated)},
		...
		{Category: "dispute", Name: "dispute.after_sale_received", Persistent: true, Sample: new(AfterSaleDisputeReceived)},
