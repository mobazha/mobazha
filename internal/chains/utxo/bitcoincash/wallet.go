...
func (w *BitcoinCashWallet) BuildTransferTx(inputs []iwallet.SweepInput, signingKey btcec.PrivateKey, changeAddress, destinationAddress string, amount, feePerByte int64) ([]byte, string, error) {
