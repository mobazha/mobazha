...
case "$mode" in
  --source)
    ...
    require_file "$repo_root/deploy/standalone/DISTRIBUTION_CHECKLIST.md"
    require_file "$repo_root/docs/project/OEM_DISTRIBUTION.md"

    require_text "$repo_root/deploy/standalone/DISTRIBUTION_CHECKLIST.md" "SOURCE_OFFER.md"
    require_text "$repo_root/deploy/standalone/DISTRIBUTION_CHECKLIST.md" "SPDX SBOM"
    require_text "$repo_root/deploy/standalone/DISTRIBUTION_CHECKLIST.md" "SHA-256 checksums"
    require_text "$repo_root/docs/project/OEM_DISTRIBUTION.md" "https://docs.mobazha.org/project/distribution"

    "$repo_root/scripts/community/check-capabilities.sh" "$repo_root"
    "$repo_root/scripts/community/check-documentation-authority.sh" "$repo_root"
