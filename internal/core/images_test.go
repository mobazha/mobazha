...
func TestMobazhaNode_SetImages(t *testing.T) {
	m, err := MockNode()
	if err != nil {
		t.Fatal(err)
	}
	...
	result, err := m.Media().SetProfileMedia(context.Background(), contracts.SlotAvatar, imgBytes)
	if err != nil {
		t.Fatal(err)
	}
...
func TestMobazhaNode_SetHeader(t *testing.T) {
	m, err := MockNode()
	if err != nil {
		t.Fatal(err)
	}
	...
	imgBytes := decodeB64(t, jpgImageB64)
	result, err := m.Media().SetProfileMedia(context.Background(), contracts.SlotHeader, imgBytes)
	if err != nil {
		t.Fatal(err)
	}
...
func TestMobazhaNode_SetProductImage(t *testing.T) {
	m, err := MockNode()
	if err != nil {
		t.Fatal(err)
	}
	...
	imgBytes := decodeB64(t, jpgImageB64)
	result, err := m.Media().UploadMedia(context.Background(), imgBytes, "testfile", contracts.UploadOpts{Variants: true})
	if err != nil {
		t.Fatal(err)
	}
...
func TestGIFAndPNG(t *testing.T) {
	...
	gifBytes := decodeB64(t, gifImageB64)
	_, err = m.Media().SetProfileMedia(context.Background(), contracts.SlotAvatar, gifBytes)
	if err != nil {
		t.Fatal(err)
	}

	pngBytes := decodeB64(t, pngImageB64)
	_, err = m.Media().SetProfileMedia(context.Background(), contracts.SlotAvatar, pngBytes)
	if err != nil {
		t.Fatal(err)
	}
}
