...
case "$mode" in
  --source)
    ...
    require_file "$repo_root/docs/community/COMMUNITY_EDITION.md"
    require_file "$repo_root/docs/community/OEM_DISTRIBUTION.md"

    require_text "$repo_root/docs/community/OEM_DISTRIBUTION.md" "not legal advice"
    require_text "$repo_root/docs/community/OEM_DISTRIBUTION.md" "SOURCE_OFFER.md"
    require_text "$repo_root/docs/community/OEM_DISTRIBUTION.md" "Mobazha Certified"
    require_text "$repo_root/docs/community/OEM_DISTRIBUTION.md" "without a required"
