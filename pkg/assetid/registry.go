...
var defaultDefinitions = []Definition{
	...
	{Code: "ETHUSDT", AssetID: "crypto:eip155:1:erc20:0xdAC17F958D2ee523a2206206994597C13D831ec7", Pricing: pricingMetaUSDPegged("USDT", "tether"), DisplaySymbol: "USDT", DisplayName: "Tether USD", Decimals: 6, Runtime: runtimeMeta(12*time.Second, 0)},
	...
	{Code: "BSCUSDT", AssetID: "crypto:eip155:56:erc20:0x55d398326f99059fF775485246999027B3197955", Pricing: pricingMetaUSDPegged("USDT", "tether"), DisplaySymbol: "USDT", DisplayName: "Tether USD on BSC", Decimals: 18, Runtime: runtimeMeta(3*time.Second, 0)},
	{Code: "BSCUSDC", AssetID: "crypto:eip155:56:erc20:0x8AC76a51cc950d9822D68b83fE1Ad97B32Cd580d", Pricing: pricingMetaUSDPegged("USDC", "usd-coin"), DisplaySymbol: "USDC", DisplayName: "USD Coin on BSC", Decimals: 18, Runtime: runtimeMeta(3*time.Second, 0)},
	...
	{Code: "ARBUSDT", AssetID: "crypto:eip155:42161:erc20:0xFd086bC7CD5C481DCC9C85ebE478A1C0b69FCbb9", Pricing: pricingMetaUSDPegged("USDT", "tether"), DisplaySymbol: "USDT", DisplayName: "Tether USD on Arbitrum", Decimals: 6, Runtime: runtimeMeta(3*time.Second, 0)},
	{Code: "ARBUSDC", AssetID: "crypto:eip155:42161:erc20:0xaf88d065e77c8cC2239327C5EDb3A432268e5831", Pricing: pricingMetaUSDPegged("USDC", "usd-coin"), DisplaySymbol: "USDC", DisplayName: "USD Coin on Arbitrum", Decimals: 6, Runtime: runtimeMeta(3*time.Second, 0)},
