...
func autoMigrateDatabase(db database.Database) error {
	dbModels := []interface{}{
		...
		&models.OutboxEvent{},
		&models.OrderExtensionRecord{},
		&models.OrderExtensionReservationRecord{},
		&models.OrderExtensionEventSequence{},
		&models.ExtensionDelivery{},
		&models.SettlementAttestationRecord{},
		&models.CollateralAccountRecord{},
		&models.CollateralFundingRecord{},
		&models.CollateralExecutionRecord{},
		&models.CollateralAllocationRecord{},
		&models.CollateralOrderExtensionBindingRecord{},
		&models.CollateralAllocationCredentialRecord{},
		&models.CollateralCredentialRefreshRecord{},
		&models.CollateralClaimRecord{},
		&models.CollateralActionRecord{},
