...
var Jobs = map[string]JobMeta{
	...
	"managed_escrow-relay-confirmations": {Name: "managed_escrow-relay-confirmations", Interval: 10 * time.Second, OverlapPolicy: OverlapSkip, MaxConcurrency: 4, PerNodeTimeout: 8 * time.Second},
