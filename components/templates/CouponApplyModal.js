      ...
      <OBLightModal visible={visible} animationType="slide">
        <ScrollView bounces={false} keyboardShouldPersistTaps="always">
          <Header
            ...
            left={<NavCloseButton />}
            onLeft={hideModal}
            right={<LinkText text={I18n.t('components.organism.CouponApplyModal.apply')} color={linkTextColor} fontSize={16} />}
            onRight={this.handleSubmit}
          />
          <View style={styles.wrapper}>
            <InputGroup title={I18n.t('components.organism.CouponApplyModal.enter_coupon')} contentStyle={styles.couponInput}>
              <TextInput
                noTitle
                noBorder
                value={couponCode}
                placeholder={I18n.t('components.organism.CouponApplyModal.enter_hint')}
            ...
            {invalid && (
              <Text style={styles.errorText}>
                {I18n.t('components.organism.CouponApplyModal.coupon')} "<Text style={styles.couponHighlight}>{couponCode}</Text>" {I18n.t('components.organism.CouponApplyModal.not_valid')}
              </Text>
            )}
          </View>
        </ScrollView>
