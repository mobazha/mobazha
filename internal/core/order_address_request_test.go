...
func TestMobazhaNode_RequestAddress(t *testing.T) {
	...
	_, err = network.Nodes()[0].Order().RequestAddress(context.Background(), network.Nodes()[1].Identity(), iwallet.CoinType("crypto:bip122:000000000019d6689c085ae165831e93:native"))
	if err == nil {
