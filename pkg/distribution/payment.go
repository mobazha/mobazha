...
// Attempt-authorized orders build intents from participant-signed attempt
// facts; orders outside settlement authorization (e.g. non-zero cancel fee)
// use PrepareManagedSolanaSetup, whose seed is likewise frozen into
// PaymentData.EscrowSeed at commit time.
