...
var toolRoutes = map[string]func(args map[string]interface{}) toolRoute{
	...
	"orders_reject":         func(a map[string]interface{}) toolRoute { return toolRoute{"POST", "/v1/orders/" + sanitizePathParam(a["orderId"]) + "/reject"} },
	...
	"chat_get_messages":     func(a map[string]interface{}) toolRoute { return toolRoute{"GET", "/v1/chat/" + sanitizePathParam(a["peerID"])} },
	"chat_send_message":     func(a map[string]interface{}) toolRoute { return toolRoute{"POST", "/v1/chat/" + sanitizePathParam(a["peerID"])} },
	"notifications_list":    func(_ map[string]interface{}) toolRoute { return toolRoute{"GET", "/v1/notifications"} },
	"exchange_rates_get":    func(_ map[string]interface{}) toolRoute { return toolRoute{"GET", "/v1/wallet/exchange-rates"} },
